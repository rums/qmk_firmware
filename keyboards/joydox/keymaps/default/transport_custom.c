...
#    ifdef TRIGGER_ENABLE
    i2c_readReg(SLAVE_I2C_ADDRESS, I2C_TRIGGER_START, (void *)&i2c_buffer->trigger_state, sizeof(i2c_buffer->trigger_state), TIMEOUT);
    trigger_update_raw(&i2c_buffer->trigger_state);
#    endif
...
#    ifdef TRIGGER_ENABLE
    trigger_state_raw(&i2c_buffer->trigger_state);
#    endif
...
#    ifdef TRIGGER_ENABLE
    trigger_update_raw((uint8_t)serial_s2m_buffer.trigger_state);
#    endif
...
#    ifdef TRIGGER_ENABLE
    trigger_state_raw((uint8_t *)serial_s2m_buffer.trigger_state);
#    endif
